...
<c:import url="header.jsp"></c:import>
    ...
    <div class="card">
        ...
        <p class="desc">SE 1.6 MT</p>
              <img class="card-img-top" src="http://localhost/imagens/carros/fiesta.png" alt="Imagem de capa do card" style="width: 80%;">
            <div class="descricao">
                <ul>
                    <li class="ano">Ano
                        <h6>2019</h6>
            ...
            <hr>
                ...
                <div class="#">
                    ...
                    <p class="compra"><img src="http://localhost/imagens/icones/volante.png" style="width: 5%;"> Ar-condicionado, direção hidráulica, travas elétricas, retrovisores elétricos, ar-quente</p>
                    </li>
                    <li class="#">   
