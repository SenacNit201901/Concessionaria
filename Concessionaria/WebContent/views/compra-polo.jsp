...
<c:import url="header.jsp"></c:import>
    ...
    <div class="card">
        ...
        <p class="desc">1.6 MSI</p>
              <img class="card-img-top" src="http://localhost/imagens/carros/polo.png" alt="Imagem de capa do card" style="width: 80%;">
            <div class="descricao">
                <ul>
                    <li class="ano">Ano
                        <h6>2020/2020</h6>
            ...
            <hr>
                ...
                <div class="#">
                    ...
                    <p><img src="http://localhost/imagens/icones/volante.png" style="width: 5%;"> Ar-condicionado, travas elétricas, retrovisores elétricos, ar-quente, direção elétrica, volante com regulagem de altura, trio eletrico</p>
                    </li>
                    <li class="#">
