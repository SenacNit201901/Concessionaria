...
<c:import url="header.jsp"></c:import>
    ...
    <p class="desc">LOGAN LIFE 1.0</p>
              <img class="card-img-top" src="http://localhost/imagens/carros/logan.png" alt="Imagem de capa do card" style="width: 80%;">
            <div class="descricao">
                <ul>
                  <li class="ano">Ano
                    <h6>2020/2020</h6>
            ...
            <hr>
                ...
                <div class="#">
                    ...
                    <li class="#">
                        ...
                        <p><img src="http://localhost/imagens/icones/cinto.png" style="width: 5%;">   Distribuição eletrônica de frenagem, airbag motorista, alarme, freios ABS, airbag passageiro, airbag lateral</p>
                    </li>
                    <li class="#">
                        
                    <p><img src="http://localhost/imagens/icones/volante.png" style="width: 5%;">   Ar-condicionado, volante com regulagem de altura, direção hidráulica, travas elétricas</p>
                    </li>
                    <li class="#">
