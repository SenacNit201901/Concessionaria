...
<c:import url="header.jsp"></c:import>
    ...
    <div class="card">
        ...
        <p class="desc">Motor 1.5L Turbo 16V DOHC Duplo VTC com Injeção Direta</p>
              <img class="card-img-top" src="http://localhost/imagens/carros/hrv.png" alt="Imagem de capa do card" style="width: 80%;">
            <div class="descricao">
                <ul>
                    <li class="ano">Ano
                        <h6>2020</h6>
