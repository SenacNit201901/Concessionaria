...
<c:import url="header.jsp"></c:import>
    ...
    <p class="desc">1.0 FLEX MANUAL</p>
              <img class="card-img-top" src="http://localhost/imagens/carros/uno.png" alt="Imagem de capa do card" style="width: 80%;">
            <div class="descricao">
                <ul>
                  <li class="ano">Ano
                    <h6>2020/2020</h6>
            ...
            <hr>
                ...
                <div class="#">
                    ...
                    <li class="#">
                        ...
                        <p><img src="http://localhost/imagens/icones/porta.png" style="width: 5%;">  Vidros elétricos dianteiros</p>
                    </li>                     
                    </ul>
                </div>
            </div>
