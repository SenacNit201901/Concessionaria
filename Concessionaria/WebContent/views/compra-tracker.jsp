...
<c:import url="header.jsp"></c:import>
    ...
    <div class="card">
        ...
        <p class="desc">MOTOR 1.4 TURBO ECOTEC</p>
              <img class="card-img-top" src="http://localhost/imagens/carros/tracker.png" alt="Imagem de capa do card" style="width: 80%;">
            <div class="descricao">
                <ul>
                    <li class="ano">Ano
                        <h6>2019/2020</h6>
            ...
            <hr>
                ...
                <div class="#">
                    ...
                    <li class="#">
                        ...
                        <p class="compra"><img src="http://localhost/imagens/icones/cinto.png" style="width: 5%;">  Airbag duplo, freios ABS, controle de tração</p>
                    </li>
                    <li class="#">
                        
                    <p class="compra"><img src="http://localhost/imagens/icones/volante.png" style="width: 5%;"> Ar-condicionado, direção hidráulica, travas elétricas, câmbio automático, volante com regulagem de altura, ar-quente</p>
                    </li>
                    <li class="#">
                        
                      <p class="compra"><img src="http://localhost/imagens/icones/banco.jpg" style="width: 5%;">  Rádio FM/AM, cd player</p>
                      </li>
                      <li class="#">
